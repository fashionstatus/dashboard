...
(function ($) {
  ...
  setTimeout(function () {
    if (window.___browserSync___ === undefined && Number(localStorage.getItem('AdminLTE:Demo:MessageShowed')) < Date.now()) {
      ...
      // eslint-disable-next-line no-alert You load AdminLTE\'s "demo.js"
  ...
  if (  $('.main-header')[0] !== undefined &&  $('.main-header')[0].classList !== undefined)
  ...
  if (  $('.brand-link')[0] !== undefined &&  $('.brand-link')[0].classList !== undefined)
  {
